...
<div class="wrapper">
   ...
   <div class="left">
    ...
    onClick function which brings user to create_quiz_A.php page
     -->
    <div class="right">
	<center>
		...
		<button id= 'create_btnA' onClick="location.href='includes/create_quiz_A.php';">Create new quiz</button>
	</center>
	</div>
	...
	<form action="courseA.php" method="post" enctype="multipart/form-data"> 
		<table class ="table_session">
            <tr>
				<td id= "create_s_header" colspan= "6" ><h1>Create New Session:<h1></td>
			</tr>
			<tr>
				<td id = "session_titles"><strong> Session Title:</strong></td>
				<td><input type="text" name="session_title" size="60" /></td>
			</tr>
			<tr>
				<td id = "session_titles"><strong> Session Course:</strong></td>
				<td>
				<div>	
				Course A
				</div>
			...
			<tr>
				<td id = "session_titles"><strong> Session Author:</strong></td>
				<td><input type="text" name="session_author" size="60" /></td>
			</tr>
			<tr>
				<td id = "session_titles"><strong> Session Image:</strong></td>
				<!-- input type file opens up file directory so admin can select an image from their local documents -->
				<td><input type="file" name="session_image" size="50" /></td>
			</tr>
			<tr>
				<td id = "session_titles"><strong> Session Info:</strong></td>
				<td><textarea name="session_info" rows="15" cols="50" ></textarea></td>
			</tr>
		</table>
		<!-- button with input type 'submit' which is referenced by the php code -->
		<button id= 'create_btnA'input type="submit" name="submit" > Publish Session Now</button>
	...
	<div id= "ie">
	<!-- input form for admin -->
	<form name ="form1"action="courseA.php" method="post" enctype="multipart/form-data"> 
		<table class ="table_exercise">
            <tr>
				<td id= "create_e_header" colspan= "6"><h1>Create New Exercise:<h1></td>
			</tr>
			<tr>
				<td id = "exercise_titles"><strong> Exercise Title:</strong></td>
				<td><input type="text" name="exercise_title" values "$_POST['exercise_title']" size="60" /></td>
			</tr>
			<tr>
				...
				<select name="ses">
					...
					<?php
					//gets session querys and runs query from database where course = 1 aka course A
					$get_sess = "select * from sessions where course_id='1'";
					$run_sess = mysqli_query($con, $get_sess);
					
					//while loop to get all the sessions wher course id = 1
			...
			<tr>
				...
				<td id = "exercise_titles"><strong> Exercise Video:</strong></td>
				<td><input type="file" name="exercise_video" size="100" /></td>
			</tr>
			<tr>
				<td id = "exercise_titles"><strong> Exercise Image:</strong></td>
