            ...
            <table class = "user_table">
                <tr>
                    <td width= "70%"; colspan = "9" id= "table_header" align = "center">
                        <h2>Add new Quiz (for Course A Sessions):</h2>
                    </td>
                    <br>
                </tr>
                <br>
                ...
                <tr>
                    ...
                    <td>
                        <select name="ses">
                            ...
                            <?php
                            //query to show and get sessions for course 1 aka course A
...
<?php
    ...
    if(isset($_POST['create_questions'])) {
        ...
        if(empty($_POST['ses'])){
            ...
            $insert_quiz = "INSERT INTO quiz_list (quiz_title, quiz_author, session_id, course_id) VALUES ('$quiz_title','$quiz_author','$quiz_ses', '1')";
            ...
            echo "<script>window.open('insert_quiz_A.php?quiz_id','_self')</script>";
        }//end of else
    } //end of if
